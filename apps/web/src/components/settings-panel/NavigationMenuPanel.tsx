...
import type { NavigationMenuType } from "config";
      ...
      <FormControlLabel
        ...
        label={
          <SettingsItem
            ...
            active={
              !disableNavigationMenuSection && navigationMenuType === "sidenav"
            }
          />
        }
      />
      <FormControlLabel
        ...
        label={
          <SettingsItem
            ...
            active={
              !disableNavigationMenuSection && navigationMenuType === "topnav"
            }
          />
        }
      />
      <FormControlLabel
        ...
        label={
          <SettingsItem
            ...
            active={
              !disableNavigationMenuSection && navigationMenuType === "combo"
            }
          />
        }
      />
